% Japanese XeLaTeX build that pulls content directly from Markdown
...
% Fonts: prefer IPAex (widely available in TeX distros); fallback to system default
\setmainfont{Latin Modern Roman}
% Prefer Japanese-capable fonts; fallback to Fandol if unavailable
\IfFontExistsTF{IPAexMincho}{\setCJKmainfont{IPAexMincho}}{%
  \IfFontExistsTF{Noto Serif CJK JP}{\setCJKmainfont{Noto Serif CJK JP}}{%
    \IfFontExistsTF{Source Han Serif JP}{\setCJKmainfont{Source Han Serif JP}}{\setCJKmainfont{FandolSong}}}}
\IfFontExistsTF{IPAexGothic}{\setCJKsansfont{IPAexGothic}}{%
  \IfFontExistsTF{Noto Sans CJK JP}{\setCJKsansfont{Noto Sans CJK JP}}{%
    \IfFontExistsTF{Source Han Sans JP}{\setCJKsansfont{Source Han Sans JP}}{\setCJKsansfont{FandolHei}}}}
% Use main CJK font for monospaced contexts as well (avoid missing mono fonts)
...
% Render the full Japanese Markdown directly
\section*{原文全文（Markdown）}
\begin{verbatim}
