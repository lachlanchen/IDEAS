...
\IfFileExists{siunitx.sty}{\usepackage{siunitx}}{%
  ...
  \newcommand{\per}{/}%
  \newcommand{\square}{\textsuperscript{2}}%
}
\usepackage{authblk}
\usepackage{setspace}
\usepackage{caption}
...
\title{OrganoidVision: Engineering Retinal Organoids as Advanced Imaging Sensors}
\author[1]{Lachlan Chen}
\author[1]{AgInTiFlow}
\affil[1]{AgInTi Lab, LazyingArt LLC}
\date{}
