...
_Ground-state geometry optimization (DFT):_
...
_Excited states (TD-DFT, 20 states, with solvent PCM if needed):_
...
1. **Choose a Dye:** Select a visible dye with a strong absorption around 600 nm (for example, a dye like _Rhodamine B_ which has peak around 550–600 nm). This will be our target $\lambda_0$. Run the quantum calculations to get its spectrum.
